public class Addressarray    //public keyword means class is available to other classes in this program
{
    ...
    public Addressarray(String User, String Street, String Number) 
    {        
        this.User = User;
        this.Street = Street;
        this.Number = Number;
